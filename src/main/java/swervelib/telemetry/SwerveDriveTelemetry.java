...
/**
 * Telemetry to describe the {@link SwerveDrive} following frc-web-components. (Which
...
public class SwerveDriveTelemetry {
   ...
   * SwerveModule#setDesiredState(SwerveModuleState, boolean, double)} is called for the
   * last module.
   */
