...
public class SwerveModuleConfiguration {
  ...
  /**
   * Conversion factor for drive motor onboard PID's and angle PID's. Use {@link
   * SwerveMath#calculateMetersPerRotation(double, double, double)} and {@link
   * SwerveMath#calculateDegreesPerSteeringRotation(double, double)} respectively to
  ...
  /**
   * Construct a configuration object for swerve modules. Assumes the absolute encoder and drive
   * motor are not inverted.
   *
   * @param driveMotor Drive {@link SwerveMotor}.
   * @param angleMotor Angle {@link SwerveMotor}
