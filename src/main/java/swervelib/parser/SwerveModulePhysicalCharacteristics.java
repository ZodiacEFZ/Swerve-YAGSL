...
public class SwerveModulePhysicalCharacteristics {
  ...
  /**
   * The conversion factors for the drive and angle motors, created by {@link
   ...
   *     {@link SwerveMath#calculateMetersPerRotation(double, double, double)} and
   ...
   * @param angleMotorRampRate The time in seconds to go from 0 to full throttle on the motor.
